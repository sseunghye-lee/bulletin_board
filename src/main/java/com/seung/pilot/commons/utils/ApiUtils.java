...
public class ApiUtils {
    ...
    public static ApiResult<?> error(ResultCode code, String message, HttpStatus status) {
    ...
    public static ResponseEntity<ApiResult<?>> newResponse(ResultCode code, String message, HttpStatus status) {
